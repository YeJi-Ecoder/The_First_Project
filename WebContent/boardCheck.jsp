...
<%-- 					<td>
						<div class="btn-group">
							<input class="btn btn-warning menu_button" value="수정" onClick="javascript:window.location='./update.tb'">
							<input type="submit" class="btn btn-danger menu_button" value="삭제" onClick="javascript:window.location='./delete.tb?boardID=${boardCheck.boardID}'">
						</div>
					</td>
 --%>
				<%} %>
